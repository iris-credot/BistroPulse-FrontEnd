...
const ScheduleCalendar = () => {
 ...
 const weekdays = t('dashboard.calendar.weekdays', { returnObjects: true }) as string[]; // Get translated week day abbreviations
...
export default function AdminDashboard() {
  ...
  const userStats: ChartData<'bar'> = {
    ...
    datasets: [
      {
        label: t('count_label'), // Assuming 'Count' is also in JSON
        data: [1200, 85, 3300],
    ...
    >
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-800 dark:text-white flex items-center">
            {t('hello_boutique')} <span className="text-2xl ml-2">👋</span>
        </h1>
         <motion.h1

        ...
        <div className="flex items-center justify-between px-6 py-4">
          <div className="flex justify-center items-center space-x-2">
             <Image 
                      ...
                      />
                       <h1 className="text-xl  font-bold text-blue-500">Botique Hotel</h1>
          </div>
        ...
        <aside className="w-64 bg-white text-gray-500 p-4 flex flex-col">
          ...
          <div className="border-t border-gray-700 pt-4">
            <ul className="space-y-1">
              ...
              <li>
                <a href="/logout" className="flex items-center space-x-3 px-3 py-2 rounded hover:text-red-950 text-red-400">

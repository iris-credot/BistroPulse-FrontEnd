        ...
        <div className="flex items-center justify-between px-4 sm:px-6 py-4">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-2 cursor-pointer" onClick={()=>{ router.push('/admin/settings');}}>
             ...
             <button title='d' onClick={toggleSidebar} className="p-2 rounded-md md:hidden text-gray-600 dark:text-gray-300">
        ...
        <AnimatePresence>
            {isSidebarOpen && (
                <>
                    {/* Overlay */}
                    <motion.div
                        className="fixed inset-0 bg-transparent bg-opacity-25 z-20 md:hidden"
                    ...
                    >
                      <div className="flex justify-end mb-4">
                        <button title='v' onClick={toggleSidebar} className="p-2 rounded-md text-gray-600 dark:text-gray-300">
                          <X className="w-6 h-6" />
                        </button>
                      </div>
                      {sidebarContent}

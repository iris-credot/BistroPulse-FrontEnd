...
const EditFood: React.FC<EditFoodProps> = ({ food, onSave, onClose }) => {
  ...
  return (
    ...
    <div className="bg-white flex-col bg-opacity-50 flex items-center justify-center z-50 p-4 max-h-screen dark:bg-transparent overflow-y-auto">
      ...
      <div className="space-y-4 w-full max-w-md">
        ...
        <div className="flex flex-col-reverse sm:flex-row sm:justify-end gap-3 pt-4">
            <Button
              onClick={onClose}
              // Added full width on mobile, auto width on larger screens
...
const EditFoodTest = () => {
  const dummyFood: FoodItem = {
    ...
    description: "Deliciously seasoned grilled chicken served with a side of steamed vegetables.",
    price: 12.99,
    category: "Main",

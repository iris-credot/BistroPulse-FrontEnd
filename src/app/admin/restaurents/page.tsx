    ...
    <div className="p-6 bg-white shadow rounded-lg">
      <div className="flex justify-between mb-4">
        ...
        <div className="flex gap-2 items-center">
          ...
          <button className="bg-blue-600 text-white px-4 py-1 rounded"  onClick={() => router.push('/admin/add-restaurent')}>Add Restaurant</button>
        ...
        <tbody>
          {restaurants.map((rest, index) => (
            <tr key={index} className="hover:bg-gray-50 border-b">
              ...
              <td className="p-2 hover:font-bold cursor-pointer" onClick={()=>{router.push('/admin/view-agentRestau')}}>{rest.representative}</td>
                ...
                {selectedMenuIndex === index && (
                  <div className="absolute right-0 mt-2 w-32 bg-white border shadow-md rounded text-sm z-10">
                    <button
                      ...
                      onClick={() => router.push('/admin/view-restaurent')}
                    >
                      View
                    </button>
                    <button
                      className="block w-full px-4 py-2 hover:bg-gray-100"
                      onClick={() => router.push('/admin/edit-restaurent')}
                    >
                      Edit
                    </button>

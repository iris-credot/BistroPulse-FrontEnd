      ...
      <div className="max-w-6xl mx-auto bg-white dark:bg-gray-800 rounded-2xl shadow p-6 space-y-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center border-b dark:border-gray-700 pb-4">
          <div className="space-y-1">
            <h2 className="text-xl font-semibold dark:text-white">Order Id #12009</h2>
          ...
          <div className="flex gap-2 mt-4 md:mt-0">
            ...
            <Button className="border px-3 py-1 rounded dark:border-gray-600 dark:text-gray-600 dark:hover:bg-gray-700">Payment</Button>
            <Button className="border px-3 py-1 rounded dark:border-gray-600 dark:text-gray-600 dark:hover:bg-gray-700">Status</Button>
          </div>
        </div>
